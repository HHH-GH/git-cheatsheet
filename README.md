...
(This README will be updated as I learn more of the various Git commands and workflows. This cheatsheet is also on my personal website.)
...
The ‘Add existing code to a new GitHub repository’ part of this post is based on:
